    ...
    const solicitudesHTML = solicitudesFiltradas.map((solicitud, index) => `
        <div class="solicitud-card" onclick="abrirDetalle(${index})">
            ...
            <div class="solicitud-badges">
                ...
                <span class="prioridad-badge prioridad-${solicitud.importancia}">
                    ${solicitud.importancia.toUpperCase()}
                </span>
            </div>
        </div>
    `).join('');
...
function abrirDetalle(index) {
    ...
    contenido.innerHTML = `
        ...
        <div class="modal-section seccion-usuario">
            ...
            <div class="modal-section-grid">
                <div class="modal-info-item">
                    ...
                    <input type="date" class="modal-input" id="edit-fecha" value="${solicitudSeleccionada.fecha}">
                </div>
                <div class="modal-info-item">
                    <div class="modal-info-label">Solicitante</div>
                    <input type="text" class="modal-input" id="edit-nombre" value="${solicitudSeleccionada.nombre}">
                </div>
                <div class="modal-info-item">
                    ...
                    <input type="hidden" id="edit-tipoMantenimiento" value="${solicitudSeleccionada.tipoMantenimiento}">
                </div>
                <div class="modal-info-item">
                    <div class="modal-info-label">Prioridad</div>
                    <select class="modal-select" id="edit-importancia">
                        <option value="alta" ${solicitudSeleccionada.importancia === 'alta' ? 'selected' : ''}>Alta</option>
                        <option value="media" ${solicitudSeleccionada.importancia === 'media' ? 'selected' : ''}>Media</option>
                        <option value="baja" ${solicitudSeleccionada.importancia === 'baja' ? 'selected' : ''}>Baja</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="modal-section seccion-activo">
            ...
            <div class="modal-section-grid">
                <div class="modal-info-item">
                    ...
                    <select class="modal-select" id="edit-numeroActivo">
                        ${generarOpciones(opcionesActivos.numeroActivo, solicitudSeleccionada.numeroActivo)}
                    </select>
                </div>
                <div class="modal-info-item">
        ...
        <div class="modal-section seccion-averia">
            <div class="modal-section-title">
            ...
            <div class="modal-section-grid primera-fila">
                <div class="modal-info-item">
                    ...
                    <select class="modal-select" id="edit-averia">
    ...
    // Actualizar labels según el tipo de mantenimiento después de que se cargue el modal
    setTimeout(() => {
        actualizarLabelsSegunTipo();
        manejarSubidaFotos();
...
function actualizarLabelsSegunTipo() {
    const hiddenTipo = document.getElementById('edit-tipoMantenimiento');
...
function guardarCambios() {
    if (solicitudSeleccionada) {
        // Obtener los valores de todos los campos editables
        ...
        // Actualizar la solicitud en el array de datos
        const index = solicitudesData.findIndex(s => s.id === solicitudSeleccionada.id);
        if (index !== -1) {
            solicitudesData[index].fecha = nuevaFecha;
            solicitudesData[index].nombre = nuevoNombre;
            ...
            filtrarSolicitudes(); // Refrescar la lista
